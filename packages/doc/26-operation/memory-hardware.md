...
3. [一张图看懂内存(RAM，ROM，FLASH)及辅助内存之间的关系](<一张图看懂内存(RAM，ROM，FLASH)及辅助内存之间的关系>)
4. [什么是内存](https://blog.csdn.net/armjishu123/article/details/4495239) --- 上图中的各种内存缩写名称解释
5. [Memory Management Reference](https://www.memorymanagement.org/index.html)
